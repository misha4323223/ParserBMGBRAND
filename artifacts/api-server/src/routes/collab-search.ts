...
=== БРЕНД BOOOMERANGS ===
Booomerangs — российский молодёжный streetwear бренд из Тулы. Продаёт одежду (толстовки, свитшоты, футболки, брюки, куртки, шорты), носки, аксессуары (кружки, ремни, сумки, шапки), а также мерч по лицензии (аниме, JDM, уличная культура и другие направления). Сайт: booomerangs.ru. Целевая аудитория: 18–30 лет.

=== ПАРТНЁРСКАЯ ПРОГРАММА — КАК РАБОТАЕТ ===
Любой блогер, творческий человек или медийная личность может стать партнёром Booomerangs — независимо от ниши и направления:
...
3. Получает уникальную реферальную ссылку и QR-код для продвижения
4. Зарабатывает комиссию с каждой продажи через его ссылку — прогрессивно: чем больше продаж, тем выше процент
5. Выплата: на карту / СБП / расчётный счёт. Полностью официально, самозанятые — чек «Мой налог», ИП/ООО — акт

КЛЮЧЕВЫЕ ПРЕИМУЩЕСТВА ДЛЯ ПАРТНЁРА:
- Своя именная страница на сайте бренда (booomerangs.ru/p/никнейм)
- Прогрессивная комиссия — растёт по мере роста продаж
- Виджет с товарами — встраивается на любой сайт, канал, соцсети
- Поддержка через Telegram и VK
- Официальный договор, полная легальность

=== ДЛЯ КОГО ПОДХОДИТ ===
Booomerangs открыты к сотрудничеству с любыми блогерами, творческими людьми и медийными личностями — мода, лайфстайл, юмор, авто, геймеры, спорт, аниме, путешествия, музыка, кулинария — любое направление, если аудитория молодая (18-30 лет) и активная.
Также возможна творческая коллаборация: создание совместного мерча, дизайнерских коллекций, брендированных капсул — партнёр получает процент от оборота своей коллекции.

=== КАК СЧИТАТЬ fitScore (1-10) ===
+3 если аудитория молодёжная (18-30 лет), активная
+2 если много подписчиков или высокая вовлечённость
+2 если есть ВКонтакте/Telegram/Инстаграм (основные каналы Booomerangs)
+1 если аудитория из России (выше конверсия)
+1 если тематика пересекается с одеждой, стилем, молодёжной культурой
...
Обязательно:
- Упомяни их конкретную тему/контент — покажи, что мы изучили кто они
- Объясни что предлагаем: партнёрка, своя страница на booomerangs.ru, комиссия с продаж
- Если тематика творческая — можно упомянуть возможность совместного мерча/коллаборации
